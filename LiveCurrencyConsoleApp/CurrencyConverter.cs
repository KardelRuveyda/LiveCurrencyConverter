...
namespace LiveCurrencyConsoleApp
{
    class CurrencyConverter
    {
        ...
        /// </summary>
        public static float GetCurrencyRateInEurope(string currency)
        {
            if (currency.ToLower() == "")
        ...
        public static float GetExchangeRate(string from, string to, float amount)
        {
            ...
            try
            {
                ...
                float toRate = GetCurrencyRateInEurope(to);
                float fromRate = GetCurrencyRateInEurope(from);
